    ...
    return (
        <div className="footer">
            <div className="footer__content">
                ...
                <a className="footer__link" target="_blank" href="https://github.com/jonathanrohland/tacboard-frontend">
                    <img className="footer__github-icon" src={githubIcon} alt={t('github-icon-alt-text')} />
                    Sieh dir den Code an
                </a>
                <a href="https://www.buymeacoffee.com/tacbrett" target="_blank" className="footer__link">{t('footer__buy-me-a-beer-link')}</a>
            </div>
        </div>
    );
}
